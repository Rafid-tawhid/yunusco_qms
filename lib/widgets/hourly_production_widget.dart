          ...
          child: ConstrainedBox(
            ...
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: Text('Buyer', style: TextStyle(color: Colors.white)),
                ),
                DataColumn(
                  label: Text('Style', style: TextStyle(color: Colors.white)),
                ),
                DataColumn(
                  label: Text('Pass', style: TextStyle(color: Colors.white)),
                ),
                DataColumn(
                  label: Text('Alter', style: TextStyle(color: Colors.white)),
                ),
                DataColumn(
              ...
              rows:
                  productionData.map((data) {
                    return DataRow(
                      cells: [
                        DataCell(
                          Text(data.timeRange ?? '-', style: _cellStyle()),
                        ),
                        DataCell(
                          Text(
                            data.lineId?.toString() ?? '-',
                            style: _cellStyle(),
                          ),
                        ),
                        DataCell(
                          Text(data.buyerName ?? '-', style: _cellStyle()),
                        ),
                        ...
                        DataCell(
                          Text(
                            data.alteration?.toString() ?? '-',
                            style: _cellStyle(color: Colors.orange[700]),
                          ),
                        ),
                        DataCell(
                          Text(
                            data.alterCheck?.toString() ?? '-',
                            style: _cellStyle(color: Colors.green[700]),
                          ),
                        ),
                        DataCell(

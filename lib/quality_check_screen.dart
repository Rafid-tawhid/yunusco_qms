...
class _QualityControlScreenState extends State<QualityControlScreen> with WidgetsBindingObserver{
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildInfoRow('PO', provider.buyerPo!.style),
                              ],
                            ),
                          ),
                          IconButton(
  ...
  Widget _buildInfoRow(String label, String? value) {
    return Row(children: [Text('$label : ', style: TextStyle(fontWeight: FontWeight.w500)), Text(DashboardHelpers.truncateString(value.toString(), 30) ?? 'Not selected', style: TextStyle(color: Colors.blue))]);
  }

  void getPreviousCount() {
    var cp = context.read<CountingProvider>();
    cp.getCountingDataLocally();
  }

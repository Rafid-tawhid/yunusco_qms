                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [Text('Select Reasons:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.grey[800]))],
                                    ),
                                  ),
                                  Expanded(
                    ...
                    selectedIndex == null || selectedReasons.isEmpty
                        ...
                        : () async {
                          ...
                          cp.addDataToLocalList(
                            bp,
                            info: {
                              'operationId': cp.operation == null ? 0 : cp.operation!.operationId,
                              'defectId': cp.allDefectList[selectedIndex ?? 0].defectId,
                              'operationDetailsId': cp.operation == null ? 0 : cp.operation!.operationDetailsId,
                            },

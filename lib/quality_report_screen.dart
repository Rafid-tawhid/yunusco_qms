                    ...
                    children: [
                      Expanded(
                        child: _buildStatCard(
                          'Total Passed',
                          (widget.stats.totalPass! +
                                  widget.stats.totalAlterCheck!)
                              .toInt(),
                          Colors.green,
                        ),
                      ),
                      ...
                      Expanded(
                        child: _buildStatCard(
                          'Total Rejected',
                          widget.stats.totalReject!.toInt(),
                          Colors.red,
                        ),
                      ),
                    ],
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: _StatCard(
            title: 'Pass Rate',
            value: total > 0 ? (widget.stats.totalPass ?? 0) / total * 100 : 0,
            icon: Icons.percent,
            color: Colors.green,
            isPercentage: true,
          ),
